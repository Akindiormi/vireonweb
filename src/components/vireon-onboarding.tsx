    ...
    >
      <div className="relative w-full max-w-xl my-8">
        <button
          onClick={onClose}
          aria-label="Close"
          className="absolute -top-12 right-0 z-10 flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-slate-300 hover:text-white hover:bg-white/20 backdrop-blur-sm transition-colors"
        >
        ...
        <motion.div
          ...
          className="relative w-full bg-slate-900 border border-white/10 rounded-[2rem] p-7 sm:p-9 shadow-2xl overflow-hidden"
        >
